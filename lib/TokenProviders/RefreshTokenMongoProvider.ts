...
import MongoTokenProviderConfig from "./AbstractMongoProvider";
 ...
 */
export default class RefreshTokenMongoProvider extends MongoTokenProviderConfig implements RefreshTokenProviderContract {
    /**
