...
declare module "@ioc:Adonis/Addons/Jwt" {
    import { DatabaseTokenProviderConfig, RedisTokenProviderConfig, ProvidersList, TokenProviderContract, ProviderTokenContract, GetProviderRealUser, GuardsList, GuardContract } from "@ioc:Adonis/Addons/Auth";
    import { DateTime } from "luxon";
    import { JWTPayload } from "jose/jwt/verify";
    type MongoTokenProviderConfig = {
        driver: 'mongo';
        model: {
            find: Function;
            findOne: Function;
    ...
    type JWTLogoutOptions = {
        refreshToken: string;
    };
    /**
     * Shape of JWT guard config.
     */
    type JWTGuardConfig<Provider extends keyof ProvidersList> = {
        /**
     ...
     */
    interface JWTTokenContract<User extends any> {
        /**
    ...
    interface JwtProviderContract extends TokenProviderContract {
    ...
    interface RefreshTokenProviderContract extends TokenProviderContract {
        destroyWithHash(token: string, type: string): Promise<void>;
    }
    interface JwtProviderTokenContract extends ProviderTokenContract {
        refreshToken: string;
     ...
     */
    interface JWTGuardContract<Provider extends keyof ProvidersList, Name extends keyof GuardsList> extends GuardContract<Provider, Name> {
        tokenProvider: JwtProviderContract | RefreshTokenProviderContract;
        payload?: JWTCustomPayloadData;
        /**
         * Attempt to verify user credentials and perform login
         */
        attempt(uid: string, password: string, options?: JWTLoginOptions): Promise<JWTTokenContract<GetProviderRealUser<Provider>>>;
        /**
         * Login a user without any verification
         */
        login(user: GetProviderRealUser<Provider>, options?: JWTLoginOptions): Promise<JWTTokenContract<GetProviderRealUser<Provider>>>;
        /**
         * Login a user using refresh token
         */
        loginViaRefreshToken(refreshToken: string, options?: JWTLoginOptions): Promise<JWTTokenContract<GetProviderRealUser<Provider>>>;
        /**
         * Generate token for a user without any verification
         */
        generate(user: GetProviderRealUser<Provider>, options?: JWTLoginOptions): Promise<JWTTokenContract<GetProviderRealUser<Provider>>>;
        /**
         * Alias for logout
         */
         ...
         */
        loginViaId(id: string | number, options?: JWTLoginOptions): Promise<JWTTokenContract<GetProviderRealUser<Provider>>>;
